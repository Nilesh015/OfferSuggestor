...
public class AccountrangesInner {
  ...
  public AccountrangesInner valueFrom(String valueFrom) {
  ...
  * @return valueFrom
  **/
  @ApiModelProperty(value = "the Account Range from value. Max length: 21 bytes")
  ...
  public AccountrangesInner companyName(String companyName) {
  ...
  * @return companyName
  **/
  @ApiModelProperty(value = "the name of the bank associated to the Account Range. Max length: 100 characters")
  ...
  public AccountrangesInner ubid(Integer ubid) {
    this.ubid = ubid;
    return this;
  }
  ...
  **/
  ...
  public AccountrangesInner valueTo(String valueTo) {
  ...
  * @return valueTo
  **/
  @ApiModelProperty(value = "the Account Range to value. Max length: 21 bytes")
  ...
  public boolean equals(Object o) {
    ...
    AccountrangesInner accountrangesInner = (AccountrangesInner) o;
    return Objects.equals(this.valueFrom, accountrangesInner.valueFrom) &&
        Objects.equals(this.companyName, accountrangesInner.companyName) &&
        Objects.equals(this.ubid, accountrangesInner.ubid) &&
        Objects.equals(this.valueTo, accountrangesInner.valueTo);
  }

  @Override
  public int hashCode() {
    return Objects.hash(valueFrom, companyName, ubid, valueTo);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AccountrangesInner {\n");
